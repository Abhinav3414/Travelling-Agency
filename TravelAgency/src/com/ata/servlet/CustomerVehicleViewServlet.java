 ...
 */
@WebServlet("/CustomerVehicleViewServlet")
public class CustomerVehicleViewServlet extends HttpServlet {
	/**
	 * 
	 */
	 ...
	 */
	public CustomerVehicleViewServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			session.setAttribute("UpdateStatus", "Please Try again !!!");
			RequestDispatcher rd = sc.getRequestDispatcher("/user.jsp");
			rd.forward(request, response);
		}
